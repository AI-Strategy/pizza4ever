...
const Newsletter = () => {
  useEffect(() => {
    document.title = 'Pizza 4 Ever - Newsletter';
  }, []);
  ...
  return (
    <div className="relative flex h-auto min-h-screen w-full flex-col group/design-root overflow-x-hidden font-montserrat">
        ...
        <main className="flex flex-1">
          <div className="flex w-full flex-wrap">
            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-8 md:p-12 bg-background-light dark:bg-background-dark">
              <form onSubmit={handleSubmit} className="flex flex-col max-w-md w-full flex-1 gap-6 py-10">
                <div className="flex flex-col items-center text-center">
                  ...
                  <h1 className="text-text-light dark:text-text-dark text-[32px] font-extrabold tracking-tight">
                    Don't Be a Stranger!
                  </h1>
                  <p className="text-subtle-light dark:text-subtle-dark text-base font-normal leading-normal mt-2">
                    Get the freshest news, hottest deals, and our worst bear puns delivered monthly. It’s un-bear-ably
                    good.
                  </p>
                </div>
                ...
                <p className="text-center text-xs text-subtle-light dark:text-subtle-dark">
                  We respect your privacy. No spam, just pizza love.
                </p>
                <div className="pt-6 text-center">
                  <p className="text-xs text-subtle-light dark:text-subtle-dark">
                    © 2024 Pizza 4 Ever. All Rights Reserved.
                  </p>
                </div>
              </form>
            </div>
